    ...
    return (
        <div className="bg-katurao-yellow  w-full px-[10%] md:px-[15%] md:text-center items-center">
            ...
            <div className="text-katurao-black font-body font-bold md:font-light text-sm md:text-2xl mb-28">
                <p className="text-left mb-4">原発事故に伴う全村避難から12年、そして避難解除から7年を経て、葛尾村は今年村制100周年を迎えました。</p><p className="text-left mb-4">
                私が初めて葛尾村を訪れたのは、避難解除から2回目の春、高校3年生のことです。その後、大学生活をこの村で過ごし、村での経験からWebエンジニアとして働く道を選びました。</p><p className="text-left mb-4">
現在、葛尾村は過渡期に差し掛かっています。昨年、中心部の集落では、震災前からの住民の数を移住者の数が超えました。</p><p className="text-left mb-8">
このような状況だからこそ、村のこれまでを引き受けながら、皆さんとともに、村のこれからを描いていけることを願っています。</p>
            <p className="mb-2 text-right">株式会社スカラパートナーズ<br />余田大輝</p>
            </div>
        </div>
    )
}