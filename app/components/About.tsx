        ...
        <div className="bg-katurao-creem w-full px-[10%] md:px-[15%]">
            ...
            <div className="px-[5%] text-xl">
                <div className="text-katurao-black mb-20">
                    <p className="font-bold font-title border-b border-katurao-black pb-2 mb-2">テーマ</p>
                    <p className="font-body">「葛尾村の消費活動をもっとワクワクするものへ。」</p>
                </div>
                <div className="text-katurao-black mb-20">
                    <p className="font-bold font-title border-b border-katurao-black pb-2 mb-2">期待すること</p>
                    <p className="mb-3">・消費活動を通じ人のつながりを醸成</p>
                    <p>・新しい生活様式の提案 など</p>
                </div>
                <div className="text-katurao-black mb-20">
                    <p className="font-bold font-title border-b border-katurao-black pb-2 mb-2">期間</p>
                    <p>2023年9月4日-9月16日</p>
                </div>
                <div className="mb-20">
                ...
                <div className="text-katurao-black mb-20">
                    <p className="font-bold font-title border-b border-katurao-black pb-2 mb-2">会場</p>
                    <p>葛尾村宿泊施設せせらぎ荘</p>
                    <div>写真とか地図とか</div>
                </div>
                <div className="text-katurao-black mb-20">
                    <p className="font-bold font-title border-b border-katurao-black pb-2 mb-2">定員</p>
                    <p>15名（5名×3チーム）</p>
                    <p>※応募者多数の場合は選考の可能性があります。</p>
                </div>
                <div className="text-katurao-black mb-20">
                    <p className="font-bold font-title border-b border-katurao-black pb-2 mb-2">参加対象</p>
                    <p>高専生(4年生以上)・大学生・大学院生。</p>
                    <p>・原則として1チーム５名の参加となりますが、5名に満たないチームでも応募可能です。</p>
                    <p>・複数の高専、大学の学生から構成されるチームでも応募できます。</p>
                </div>
                <div className="text-katurao-black mb-20">
                    <p className="font-bold font-title border-b border-katurao-black pb-2 mb-2">参加費</p>
                    <p>なし。</p>
                    <p>※交通費・食費は参加者負担となります。</p>
                    <p>宿泊費は実行委員会からの全額負担となります。</p>
                </div>
                <div className="text-katurao-black mb-20">
                    <p className="font-bold font-title border-b border-katurao-black pb-2 mb-2">申込締切</p>
                    <p>7月28日まで。</p>
                    <p>選考結果は8月4日頃代表者へご連絡します。</p>
                </div>
                <div className="text-katurao-black mb-20">
                    <p className="font-bold font-title border-b border-katurao-black pb-2 mb-2 text-5xl">表彰</p>
                    <div>WED賞</div>
                    <div>スカラ賞</div>
                </div>
                <div className="text-katurao-black mb-20">
                    <p className="font-bold font-title border-b border-katurao-black pb-2 mb-2 text-5xl">協賛</p>
                    <div>ロゴやらなんやら</div>
                    <div>ロゴやらなんやら</div>
                    <div>ロゴやらなんやら</div>
                </div>
